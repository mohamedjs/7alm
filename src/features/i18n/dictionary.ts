...
const en = {
  ...
  // ---------------------------------------------------------------
  // aiStudio.* — /admin/ai-studio (trends → design ideas dashboard)
  // ---------------------------------------------------------------
  "aiStudio.title": "AI Studio",
  "aiStudio.trends.title": "Trends",
  "aiStudio.trends.empty": "No trends yet. Add one to seed the Design Director.",
  "aiStudio.trends.addTitle": "Add Trend",
  "aiStudio.trends.summary": "Summary",
  "aiStudio.trends.summaryPlaceholder": "What's the trend? e.g. \"Marble-effect cases trending on Pinterest\"",
  "aiStudio.trends.score": "Score",
  "aiStudio.trends.scorePlaceholder": "0–1, optional",
  "aiStudio.trends.submit": "Add Trend",
  "aiStudio.trends.submitting": "Adding...",
  "aiStudio.trends.col.source": "Source",
  "aiStudio.trends.col.summary": "Summary",
  "aiStudio.trends.col.score": "Score",
  "aiStudio.trends.col.status": "Status",
  "aiStudio.trends.col.collectedAt": "Collected",
  "aiStudio.trends.source.pinterest": "Pinterest",
  "aiStudio.trends.source.etsy": "Etsy",
  "aiStudio.trends.source.tiktok": "TikTok",
  "aiStudio.trends.source.instagram": "Instagram",
  "aiStudio.trends.source.google_trends": "Google Trends",
  "aiStudio.trends.source.reddit": "Reddit",
  "aiStudio.trends.source.amazon": "Amazon",
  "aiStudio.trends.source.manual": "Manual",
  "aiStudio.trends.status.new": "New",
  "aiStudio.trends.status.summarized": "Summarized",
  "aiStudio.trends.status.used": "Used",
  "aiStudio.trends.status.archived": "Archived",
  "aiStudio.ideas.title": "Design Ideas",
  "aiStudio.ideas.empty": "No design ideas yet.",
  "aiStudio.ideas.filter.all": "All",
  "aiStudio.ideas.favorite": "Favorite",
  "aiStudio.status.pendingReview": "Pending Review",
  "aiStudio.status.approved": "Approved",
  "aiStudio.status.rejected": "Rejected",
  "aiStudio.status.possibleDuplicate": "Possible Duplicate",
  "aiStudio.status.published": "Published",
  "aiStudio.action.approve": "Approve",
  "aiStudio.action.reject": "Reject",
  "aiStudio.action.publish": "Publish",
} as const;
...
const ar: Record<DictKey, string> = {
  ...
  "aiStudio.title": "استوديو الذكاء الاصطناعي",
  "aiStudio.trends.title": "الاتجاهات",
  "aiStudio.trends.empty": "لا توجد اتجاهات بعد. أضف واحداً لتغذية مولّد الأفكار.",
  "aiStudio.trends.addTitle": "إضافة اتجاه",
  "aiStudio.trends.summary": "الملخص",
  "aiStudio.trends.summaryPlaceholder": "ما هو الاتجاه؟ مثال: \"أغطية بتأثير الرخام رائجة على بينتريست\"",
  "aiStudio.trends.score": "التقييم",
  "aiStudio.trends.scorePlaceholder": "0–1، اختياري",
  "aiStudio.trends.submit": "إضافة اتجاه",
  "aiStudio.trends.submitting": "جارٍ الإضافة...",
  "aiStudio.trends.col.source": "المصدر",
  "aiStudio.trends.col.summary": "الملخص",
  "aiStudio.trends.col.score": "التقييم",
  "aiStudio.trends.col.status": "الحالة",
  "aiStudio.trends.col.collectedAt": "تاريخ الجمع",
  "aiStudio.trends.source.pinterest": "بينتريست",
  "aiStudio.trends.source.etsy": "إتسي",
  "aiStudio.trends.source.tiktok": "تيك توك",
  "aiStudio.trends.source.instagram": "إنستغرام",
  "aiStudio.trends.source.google_trends": "جوجل ترندز",
  "aiStudio.trends.source.reddit": "ريديت",
  "aiStudio.trends.source.amazon": "أمازون",
  "aiStudio.trends.source.manual": "يدوي",
  "aiStudio.trends.status.new": "جديد",
  "aiStudio.trends.status.summarized": "تم تلخيصه",
  "aiStudio.trends.status.used": "مستخدم",
  "aiStudio.trends.status.archived": "مؤرشف",
  "aiStudio.ideas.title": "أفكار التصميم",
  "aiStudio.ideas.empty": "لا توجد أفكار تصميم بعد.",
  "aiStudio.ideas.filter.all": "الكل",
  "aiStudio.ideas.favorite": "مفضّل",
  "aiStudio.status.pendingReview": "قيد المراجعة",
  "aiStudio.status.approved": "تمت الموافقة",
  "aiStudio.status.rejected": "مرفوض",
  "aiStudio.status.possibleDuplicate": "تكرار محتمل",
  "aiStudio.status.published": "منشور",
  "aiStudio.action.approve": "موافقة",
  "aiStudio.action.reject": "رفض",
  "aiStudio.action.publish": "نشر",
};
